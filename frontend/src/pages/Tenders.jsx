...
const Tenders = () => {
    ...
    const fetchTenders = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:5000/api/tenders?${query}`);
    ...
    return (
        <div className="section">
            ...
            <p>Browse the latest government tenders and procurement opportunities.</p>
            ...
            {loading ? (
                <div className="loading">
                    <i className="fas fa-spinner fa-spin"></i> Loading tenders...
                </div>
            ) : tenders.length > 0 ? (
                ...
                <div className="no-data">
                    <i className="fas fa-info-circle"></i> No tenders found matching your criteria.
                </div>
            )}
        </div>
    );
